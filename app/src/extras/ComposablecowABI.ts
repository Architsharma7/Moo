export const COMPOSABLE_COW_ABI = [
    ...
    { inputs: [], name: 'SwapGuardRestricted', type: 'error' },
    {
        ...
        inputs: [
            ...
            {
                components: [
                    { internalType: 'contract IConditionalOrder', name: 'handler', type: 'address' },
    ...
    },
    {
        ...
        inputs: [
            { indexed: true, internalType: 'address', name: 'owner', type: 'address' },
            { indexed: false, internalType: 'contract ISwapGuard', name: 'swapGuard', type: 'address' },
        ],
        name: 'SwapGuardSet',
        type: 'event',
    },
    ...
    },
    {
        inputs: [
            ...
            { internalType: 'contract IValueFactory', name: 'factory', type: 'address' },
            { internalType: 'bytes', name: 'data', type: 'bytes' },
            { internalType: 'bool', name: 'dispatch', type: 'bool' },
        ],
    ...
    {
        inputs: [{ internalType: 'bytes32', name: 'singleOrderHash', type: 'bytes32' }],
        name: 'remove',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
    ...
    {
        inputs: [{ internalType: 'contract ISwapGuard', name: 'swapGuard', type: 'address' }],
        name: 'setSwapGuard',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
    ...
    },
    {
        inputs: [{ internalType: 'address', name: '', type: 'address' }],
        name: 'swapGuards',
        outputs: [{ internalType: 'contract ISwapGuard', name: '', type: 'address' }],
        stateMutability: 'view',
        type: 'function',
    },
];
